...
def test_search_excludes_every_archived_document_before_ranking() -> None:
    client = TestClient(create_app())
...
def test_search_rejects_invalid_or_extra_request_fields() -> None:
    client = TestClient(create_app())
...
def test_runtime_constants_match_frozen_selected_configuration() -> None:
    selected = json.loads(
